...
const Register = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-24 min-h-screen">
            ...
            >
                <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent break-words">Event Registration</h1>
